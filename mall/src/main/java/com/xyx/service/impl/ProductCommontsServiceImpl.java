...
import com.xyx.mapper.ProductCommentsMapper;
...
public class ProductCommontsServiceImpl implements ProductCommontsService {
    ...
    public ResultVO listCommontsByProductId(String productId, int pageNum, int limit) {
        ...
        ResultVO resultVO = new ResultVO(ResStatus.OK, "success", new PageUtil<ProductCommentsVO>(count,pageCount,list));
        return resultVO;
    }
