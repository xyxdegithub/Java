 ...
 * @date 2023/7/30 030 20:32
 * @description: TODO
 */
public class QueryScoreView extends JFrame {
    ...
    public QueryScoreView() throws HeadlessException {
        ...
        confirm.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    //数据库添加
                    StuScoreService.query(idText.getText(),model);
